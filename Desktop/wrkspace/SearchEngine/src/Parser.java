...
public class Parser {
	...
	public static void main(String args[]) throws Exception{
		File root = new File("/home/sdfgsdfg/Desktop/Resources/");  	// Set root directory for crawler.
		
		
		parseDir(root);				// Get contents [ *.html ]
		...
		if(fd.isDirectory()){
			...
			for( File f : files ){
				...
				for( String s : lines ){
					...
					s = s.replaceAll("\\W", " ");	// Replace non-alphanumericals.
					s = s.toLowerCase();
